...
```bash
curl --location 'http://qz.sii.edu.cn/openapi/v1/inference_servings/create' \
...
- 请求方式：`POST`。
- 请求地址：`https://qz.sii.edu.cn/openapi/v1/inference_servings/create`。

#### 请求参数

| 参数 | 类型 | 是否必选 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| name | String | 是 | test-sv | 模型部署服务名称。 |
...
- 请求方式：`POST`。
- 请求地址：`https://qz.sii.edu.cn/openapi/v1/inference_servings/detail`。

#### 请求参数

| 参数 | 类型 | 是否必选 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| inference_serving_id | String | 是 | sv-e824d6e8-5a41-4dce-bec2-aafea83bxxxx | 模型部署服务 ID。 |

#### 请求示例

```bash
curl --location --request POST 'https://qz.sii.edu.cn/openapi/v1/inference_servings/detail' \
  --header 'Authorization: Bearer xxxx' \
  --data-raw '{
    "inference_serving_id": "sv-e824d6e8-5a41-4dce-bec2-aafea83bxxxx"
  }'
```
...
- 请求方式：`POST`。
- 请求地址：`https://qz.sii.edu.cn/openapi/v1/inference_servings/stop`。
...
```bash
curl --location --request POST 'https://qz.sii.edu.cn/openapi/v1/inference_servings/stop' \
  --header 'Authorization: Bearer xxxx' \
  --data-raw '{
    "inference_serving_id": "sv-e824d6e8-5a41-4dce-bec2-aafea83bxxxx"
  }'
